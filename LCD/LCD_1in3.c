...
static void LCD_1IN3_InitReg(void)
{
    ...
    LCD_1IN3_SendCommand(0xB2); //PORCH SETTING 
    LCD_1IN3_SendData_8Bit(0x01); //back porch in normal mode
    LCD_1IN3_SendData_8Bit(0x01); //front porch in nomral mode
    LCD_1IN3_SendData_8Bit(0x00); //psen
    LCD_1IN3_SendData_8Bit(0x33); //back porch and front porch setting in idle mode
    LCD_1IN3_SendData_8Bit(0x33); //back porch and front porch setting in partial mode

    LCD_1IN3_SendCommand(0xB7);  //GATE CONTROL
    LCD_1IN3_SendData_8Bit(0x35); //VGH AND VGL settings
    ...
    LCD_1IN3_SendData_8Bit(0x00); //default is 0x0f
